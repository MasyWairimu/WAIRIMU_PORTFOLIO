        ...
        <div className='ExperienceSection'>
            ...
            <div className='experienceContent'>
                ...
                <div className='experience' eventKey="G-Tech" title="G-Tech">
                    ...
                    <p className='text'>
                        ● Worked with mobile developers in the front-end development <br /> of a mobile software that
                        could enables patients <br /> with diabetes and blood pressure
                        conditions to directly contact their doctors through <br />an app
                        identified as Doc&I
                    </p>
                    <p className='text'>
                        ● Conducted the testing of the software to ensure that the system was smooth and <br />
